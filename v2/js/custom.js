...
　 }　
	...
	function mapInitialize() {
	  ...
	  var yourLatitude = 48.833;
	  var yourLongitude = 2.333;
    ...
    $contactForm.submit(function(){
        var $success      = '<strong>Success!</strong> Message envoyé avec succes.';
	    var $error      = '<strong>Error!</strong> Message non envoyé - Veuillez réessayer...';
      	var response;
